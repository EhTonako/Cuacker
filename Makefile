...
a.out: main.o cuac/cuac.o diccionarioCuacs/diccionarioCuacs.o fecha/fecha.o tablaHash/tablaHash.o
	g++ main.o cuac/cuac.o diccionarioCuacs/diccionarioCuacs.o fecha/fecha.o tablaHash/tablaHash.o -o a.out

cuac.o: cuac/cuac.cpp cuac/cuac.h fecha/fecha.h
	g++ -c cuac/cuac.cpp -o cuac/cuac.o

diccionarioCuacs.o: diccionarioCuacs/diccionarioCuacs.cpp diccionarioCuacs/diccionarioCuacs.h cuac/cuac.h fecha/fecha.h tablaHash/tablaHash.h
...
main.o: main.cpp cuac/cuac.h diccionarioCuacs/diccionarioCuacs.h fecha/fecha.h tablaHash/tablaHash.h
